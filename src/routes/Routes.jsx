...
const AppRoutes = () => {
  return (
    <ReactRouterRoutes>
      {/* 1. PAGE D'ACCUEIL (Doit être la route racine "/") */}
      <Route path="/" element={<Home />} />

      {/* 2. ROUTES DE LECTURE (Les plus spécifiques, toujours en premier) */}
      <Route path={`${BASE_PATH}/:category/play/:id`} element={<Watch />} />

      {/* 3. ROUTES STATIQUES (Lien direct vers les pages d'information) */}
